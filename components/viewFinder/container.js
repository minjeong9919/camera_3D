...
export const container = () => {
  ...
  shape.quadraticCurveTo(
    ...
    height + backHeight,
    frontDepth + radius,
    height + backHeight + radius
  );
  shape.quadraticCurveTo(
    frontDepth + radius,
    height + backHeight + radius,
    frontDepth + radius + 0.03,
    height + backHeight
  );
  ...
  const viewFinderMesh = new THREE.Mesh(viewFinderGeometry, metalMaterial);
  viewFinderMesh.position.y = 0.4;
  viewFinderMesh.position.z = 0.5;
  viewFinderMesh.position.x = -0.7 - 0.35;
